...
func (n *NSSet) MakeObjectsPerformSelector(aSelector *objc.Selector) {
	C.C_NSSet_MakeObjectsPerformSelector(n.Ptr(), objc.ExtractPtr(aSelector))
}

func (n *NSSet) MakeObjectsPerformSelector_WithObject(aSelector *objc.Selector, argument objc.Object) {
	C.C_NSSet_MakeObjectsPerformSelector_WithObject(n.Ptr(), objc.ExtractPtr(aSelector), objc.ExtractPtr(argument))
}
