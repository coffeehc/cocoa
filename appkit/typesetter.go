...
func (n *NSTypesetter) Init() Typesetter {
	result := C.C_NSTypesetter_Init(n.Ptr())
	return MakeTypesetter(result)
}

func Typesetter_SharedSystemTypesetterForBehavior(behavior TypesetterBehavior) objc.Object {
	result := C.C_NSTypesetter_Typesetter_SharedSystemTypesetterForBehavior(C.int(int(behavior)))
...
func (n *NSTypesetter) BaselineOffsetInLayoutManager_GlyphIndex(layoutMgr LayoutManager, glyphIndex uint) coregraphics.Float {
	result := C.C_NSTypesetter_BaselineOffsetInLayoutManager_GlyphIndex(n.Ptr(), objc.ExtractPtr(layoutMgr), C.uint(glyphIndex))
	return coregraphics.Float(float64(result))
}

func (n *NSTypesetter) SubstituteFontForFont(originalFont Font) Font {
	result := C.C_NSTypesetter_SubstituteFontForFont(n.Ptr(), objc.ExtractPtr(originalFont))
...
func (n *NSTypesetter) TextTabForGlyphLocation_WritingDirection_MaxLocation(glyphLocation coregraphics.Float, direction WritingDirection, maxLocation coregraphics.Float) TextTab {
	result := C.C_NSTypesetter_TextTabForGlyphLocation_WritingDirection_MaxLocation(n.Ptr(), C.double(float64(glyphLocation)), C.int(int(direction)), C.double(float64(maxLocation)))
...
func (n *NSTypesetter) LineSpacingAfterGlyphAtIndex_WithProposedLineFragmentRect(glyphIndex uint, rect foundation.Rect) coregraphics.Float {
	result := C.C_NSTypesetter_LineSpacingAfterGlyphAtIndex_WithProposedLineFragmentRect(n.Ptr(), C.uint(glyphIndex), *(*C.CGRect)(coregraphics.ToCGRectPointer(coregraphics.Rect(rect))))
	return coregraphics.Float(float64(result))
}
...
func (n *NSTypesetter) ParagraphSpacingAfterGlyphAtIndex_WithProposedLineFragmentRect(glyphIndex uint, rect foundation.Rect) coregraphics.Float {
	result := C.C_NSTypesetter_ParagraphSpacingAfterGlyphAtIndex_WithProposedLineFragmentRect(n.Ptr(), C.uint(glyphIndex), *(*C.CGRect)(coregraphics.ToCGRectPointer(coregraphics.Rect(rect))))
	return coregraphics.Float(float64(result))
}
...
func (n *NSTypesetter) ParagraphSpacingBeforeGlyphAtIndex_WithProposedLineFragmentRect(glyphIndex uint, rect foundation.Rect) coregraphics.Float {
	result := C.C_NSTypesetter_ParagraphSpacingBeforeGlyphAtIndex_WithProposedLineFragmentRect(n.Ptr(), C.uint(glyphIndex), *(*C.CGRect)(coregraphics.ToCGRectPointer(coregraphics.Rect(rect))))
	return coregraphics.Float(float64(result))
}
...
func (n *NSTypesetter) LayoutCharactersInRange_ForLayoutManager_MaximumNumberOfLineFragments(characterRange foundation.Range, layoutManager LayoutManager, maxNumLines uint) foundation.Range {
	result := C.C_NSTypesetter_LayoutCharactersInRange_ForLayoutManager_MaximumNumberOfLineFragments(n.Ptr(), *(*C.NSRange)(foundation.ToNSRangePointer(characterRange)), objc.ExtractPtr(layoutManager), C.uint(maxNumLines))
...
func (n *NSTypesetter) HyphenationFactorForGlyphAtIndex(glyphIndex uint) float32 {
	result := C.C_NSTypesetter_HyphenationFactorForGlyphAtIndex(n.Ptr(), C.uint(glyphIndex))
	return float32(result)
}

func (n *NSTypesetter) ShouldBreakLineByHyphenatingBeforeCharacterAtIndex(charIndex uint) bool {
	result := C.C_NSTypesetter_ShouldBreakLineByHyphenatingBeforeCharacterAtIndex(n.Ptr(), C.uint(charIndex))
	return bool(result)
}

func (n *NSTypesetter) ShouldBreakLineByWordBeforeCharacterAtIndex(charIndex uint) bool {
	result := C.C_NSTypesetter_ShouldBreakLineByWordBeforeCharacterAtIndex(n.Ptr(), C.uint(charIndex))
	return bool(result)
}
...
func (n *NSTypesetter) TypesetterBehavior() TypesetterBehavior {
	result := C.C_NSTypesetter_TypesetterBehavior(n.Ptr())
	return TypesetterBehavior(int(result))
}
...
func (n *NSTypesetter) HyphenationFactor() float32 {
	result := C.C_NSTypesetter_HyphenationFactor(n.Ptr())
	return float32(result)
}
...
func (n *NSTypesetter) CurrentTextContainer() TextContainer {
	result := C.C_NSTypesetter_CurrentTextContainer(n.Ptr())
	return MakeTextContainer(result)
}

func (n *NSTypesetter) TextContainers() []TextContainer {
	result := C.C_NSTypesetter_TextContainers(n.Ptr())
...
func (n *NSTypesetter) LineFragmentPadding() coregraphics.Float {
	result := C.C_NSTypesetter_LineFragmentPadding(n.Ptr())
	return coregraphics.Float(float64(result))
}
...
func (n *NSTypesetter) BidiProcessingEnabled() bool {
	result := C.C_NSTypesetter_BidiProcessingEnabled(n.Ptr())
	return bool(result)
}
...
func (n *NSTypesetter) CurrentParagraphStyle() ParagraphStyle {
	result := C.C_NSTypesetter_CurrentParagraphStyle(n.Ptr())
	return MakeParagraphStyle(result)
}

func (n *NSTypesetter) AttributedString() foundation.AttributedString {
	result := C.C_NSTypesetter_AttributedString(n.Ptr())
...
func (n *NSTypesetter) ParagraphGlyphRange() foundation.Range {
	result := C.C_NSTypesetter_ParagraphGlyphRange(n.Ptr())
	return foundation.FromNSRangePointer(unsafe.Pointer(&result))
}

func (n *NSTypesetter) ParagraphSeparatorGlyphRange() foundation.Range {
	result := C.C_NSTypesetter_ParagraphSeparatorGlyphRange(n.Ptr())
	return foundation.FromNSRangePointer(unsafe.Pointer(&result))
}

func (n *NSTypesetter) ParagraphCharacterRange() foundation.Range {
	result := C.C_NSTypesetter_ParagraphCharacterRange(n.Ptr())
	return foundation.FromNSRangePointer(unsafe.Pointer(&result))
}

func (n *NSTypesetter) ParagraphSeparatorCharacterRange() foundation.Range {
	result := C.C_NSTypesetter_ParagraphSeparatorCharacterRange(n.Ptr())
	return foundation.FromNSRangePointer(unsafe.Pointer(&result))
}
