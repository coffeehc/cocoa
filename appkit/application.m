...
@end
void Application_SetDelegate(void *ptr, long goID) {
	NSApplication* application = (NSApplication*)ptr;
	MyNSApplicationDelegate* delegate = [[MyNSApplicationDelegate alloc] init];
...
Array Application_Windows(void* ptr) {
	NSApplication* application = (NSApplication*)ptr;
	NSArray* ns_array = [application windows];
