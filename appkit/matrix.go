...
func (n *NSMatrix) SortUsingSelector(comparator *objc.Selector) {
	C.C_NSMatrix_SortUsingSelector(n.Ptr(), objc.ExtractPtr(comparator))
}
...
func (n *NSMatrix) SendAction_To_ForAllCells(selector *objc.Selector, object objc.Object, flag bool) {
	C.C_NSMatrix_SendAction_To_ForAllCells(n.Ptr(), objc.ExtractPtr(selector), objc.ExtractPtr(object), C.bool(flag))
}
...
func (n *NSMatrix) SetDoubleAction(value *objc.Selector) {
	C.C_NSMatrix_SetDoubleAction(n.Ptr(), objc.ExtractPtr(value))
}
