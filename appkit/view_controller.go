...
func ViewControllerPresentationAnimatorToObjc(protocol ViewControllerPresentationAnimator) objc.Object {
...
func viewControllerPresentationAnimator_AnimatePresentationOfViewController_FromViewController(hp C.uintptr_t, viewController unsafe.Pointer, fromViewController unsafe.Pointer) {
	protocol := cgo.Handle(hp).Value().(ViewControllerPresentationAnimator)
	protocol.AnimatePresentationOfViewController_FromViewController(MakeViewController(viewController), MakeViewController(fromViewController))
}
...
func viewControllerPresentationAnimator_AnimateDismissalOfViewController_FromViewController(hp C.uintptr_t, viewController unsafe.Pointer, fromViewController unsafe.Pointer) {
	protocol := cgo.Handle(hp).Value().(ViewControllerPresentationAnimator)
	protocol.AnimateDismissalOfViewController_FromViewController(MakeViewController(viewController), MakeViewController(fromViewController))
}
