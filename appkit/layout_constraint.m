...
void LayoutConstraint_ActivateConstraints(Array constraints) {
    NSMutableArray* objc_constraints = [[NSMutableArray alloc] init];
    void** constraintsData = (void**)constraints.data;
    for (int i = 0; i < constraints.len; i++) {
    	[objc_constraints addObject:(NSLayoutConstraint*)constraintsData[i]];
    }
	[NSLayoutConstraint activateConstraints:objc_constraints];
}
...
void LayoutConstraint_DeactivateConstraints(Array constraints) {
	...
	[NSLayoutConstraint deactivateConstraints:objc_constraints];
}
