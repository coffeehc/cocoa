...
func (n NSResponder) SupplementalTargetForAction_Sender(action objc.Selector, sender objc.Object) objc.Object {
	result_ := C.C_NSResponder_SupplementalTargetForAction_Sender(n.Ptr(), unsafe.Pointer(action), objc.ExtractPtr(sender))
...
func (n NSResponder) TryToPerform_With(action objc.Selector, object objc.Object) bool {
	result_ := C.C_NSResponder_TryToPerform_With(n.Ptr(), unsafe.Pointer(action), objc.ExtractPtr(object))
	return bool(result_)
}
...
func (n NSResponder) NoResponderFor(eventSelector objc.Selector) {
	C.C_NSResponder_NoResponderFor(n.Ptr(), unsafe.Pointer(eventSelector))
}
